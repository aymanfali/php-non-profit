        ...
        <div class="bg-bg p-6 rounded-lg shadow-md mb-6 w-full md:w-1/2">
            ...
            <form @submit.prevent="handleSubmit">
                ...
                <div class="mb-4">
                    ...
                    <input id="name" v-model="user.name" type="text" class="w-full px-3 py-2 border rounded"
                ...
                <div class="mb-4">
                    ...
                    <input id="email" v-model="user.email" type="email" class="w-full px-3 py-2 border rounded"
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input id="password" v-model="user.password" :type="showPassword ? 'text' : 'password'"
                            class="w-full px-3 py-2 border rounded pr-10" :class="{ 'border-red-500': errors.password }"
                ...
                <div class="mb-4">
                    ...
                    <input id="confirmPassword" v-model="user.confirmPassword" type="password"
                        class="w-full px-3 py-2 border rounded" :class="{ 'border-red-500': errors.confirmPassword }"
                ...
                <div class="mb-4">
                    ...
                    <select id="role" v-model="user.role" class="w-full px-3 py-2 border rounded">
